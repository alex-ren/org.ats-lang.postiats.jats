...
/*
/home/grad2/aren/workspace/Postiats/projects/org.ats-lang.postiats.jats/test/test13.dats: 43(line=4, offs=5) -- 68(line=4, offs=30)
*/
/*
local: 
...
ATSINSmove(tmp16, PMVtmpltcst(g1int2int<S2EVar(399->S2Eextkind(atstype_int)), S2EVar(400->S2Evar(tk(2922)))>)(arg1)) ;
ATSINSmove(tmpret15, PMVtmpltcst(g1int_eq<S2Evar(tk(2922))>)(arg0, tmp16)) ;
/* funbodyinstrlst(end) */
ATSreturn(tmpret15) ;
...
/* funbodyinstrlst(beg) */
__patsflab_eq_g1int_int:
ATSINSmove(tmp16$1, atspre_g1int2int_int_int(arg1)) ;
ATSINSmove(tmp15$1, atspre_g1int_eq_int(arg0, tmp16$1)) ;
/* funbodyinstrlst(end) */
ATSreturn(tmp15$1) ;
...
/*
/home/grad2/aren/workspace/Postiats/projects/org.ats-lang.postiats.jats/test/test13.dats: 86(line=6, offs=17) -- 479(line=29, offs=7)
*/
/*
local: foo_int_0$0(0)
...
ATStmpdec(tmpref4, atstkind_t0ype(atstype_int)) ;
ATStmpdec(tmp5, postiats_tyrec_0) ;
ATStmpdec(tmpref6, postiats_tyrec_0) ;
ATStmpdec(tmp7, postiats_tyrec_0) ;
ATStmpdec(tmp8, atstkind_t0ype(atstype_int)) ;
ATStmpdec(tmp9, postiats_tyrec_0) ;
ATStmpdec(tmpref10, postiats_tyrec_0) ;
ATStmpdec(tmpref11, postiats_tyrec_1) ;
...
*/
ATSINSmove(tmp3, foo_int_0(ATSPMVi0nt(3))) ;
ATSINSstore(tmpref2, tmp3) ;
/*
ATSINStmpdec(tmpref4)) ;
*/
ATSINSstore(tmpref4, tmpref2) ;
ATSINSstore_fltrec_ofs (tmp5, postiats_tyrec_0, atslab$0, ATSPMVi0nt(1)) ;
ATSINSstore_fltrec_ofs (tmp5, postiats_tyrec_0, atslab$1, ATSPMVi0nt(2)) ;
/*
ATSINStmpdec(tmpref6)) ;
*/
ATSINSmove(tmpref6, tmp5) ;
ATSINSmove(tmp7, tmpref6) ;
ATSINSmove(tmp8, foo_int_0(ATSselfltrec(tmp7, postiats_tyrec_0, atslab$0))) ;
ATSINSstore_fltrec_ofs (tmp9, postiats_tyrec_0, atslab$0, ATSPMVi0nt(3)) ;
ATSINSstore_fltrec_ofs (tmp9, postiats_tyrec_0, atslab$1, ATSPMVi0nt(4)) ;
ATSINSstore(tmpref6, tmp9) ;
ATSINSstore(ATSselfltrec(tmpref6, postiats_tyrec_0, atslab$0), ATSPMVi0nt(6)) ;
/*
ATSINStmpdec(tmpref10)) ;
*/
ATSINSstore(ATSselfltrec(tmpref10, postiats_tyrec_0, atslab$0), ATSPMVi0nt(3)) ;
/*
ATSINStmpdec(tmpref11)) ;
*/
ATSINSstore(ATSselfltrec(ATSselfltrec(tmpref11, postiats_tyrec_1, atslab$1), postiats_tyrec_0, atslab$0), ATSPMVi0nt(3)) ;
ATSINSmove(tmp12, foo_int_0(ATSselfltrec(ATSselfltrec(tmpref11, postiats_tyrec_1, atslab$1), postiats_tyrec_0, atslab$0))) ;
ATSINSmove(tmp14, _057$home_057$grad2_057$aren_057$workspace_057$Postiats_057$ATS_055$Postiats_057$prelude_057$SATS_057$integer_056$sats_eq_g1int_int$2$1(ATSselfltrec(ATSselfltrec(tmpref11, postiats_tyrec_1, atslab$1), postiats_tyrec_0, atslab$0), ATSPMVi0nt(3))) ;
ATSINSmove_void(tmp13, atspre_assert_errmsg_bool1(tmp14, ATSCSTSPmyloc("/home/grad2/aren/workspace/Postiats/projects/org.ats-lang.postiats.jats/test/test13.dats: 450(line=28, offs=12) -- 471(line=28, offs=33)"))) ;
/*
letpush(end)
*/
...
*/
atsvoid_t0ype
_057$home_057$grad2_057$aren_057$workspace_057$Postiats_057$projects_057$org_056$ats_055$lang_056$postiats_056$jats_057$test_057$test13_056$dats__dynload()
{
ATSdynload0(
_057$home_057$grad2_057$aren_057$workspace_057$Postiats_057$projects_057$org_056$ats_055$lang_056$postiats_056$jats_057$test_057$test13_056$dats__dynloadflag
) ;
ATSif(
ATSCKiseqz(
_057$home_057$grad2_057$aren_057$workspace_057$Postiats_057$projects_057$org_056$ats_055$lang_056$postiats_056$jats_057$test_057$test13_056$dats__dynloadflag
...
ATSdynloadset(_057$home_057$grad2_057$aren_057$workspace_057$Postiats_057$projects_057$org_056$ats_055$lang_056$postiats_056$jats_057$test_057$test13_056$dats__dynloadflag) ;
} /* ATSendif */
ATSreturn_void() ;
} /* end of [*_dynload] */
