...
ATSINSmove(tmp16, PMVtmpltcst(g1int2int<S2Eextkind(atstype_int), S2Evar(tk(3165))>)(arg1)) ;
ATSINSmove(tmpret15, PMVtmpltcst(g1int_eq<S2Evar(tk(3165))>)(arg0, tmp16)) ;
/* funbodyinstrlst(end) */
ATSreturn(tmpret15) ;
...
*/
/*
local: foo_int_0$0(level=0)
global: foo_int_0$0(level=0), mainats_void_0$1$0(level=0)
local: 
global: 
*/
ATSglobaldec()
...
ATSINSmove(tmp14, ATSLIB_056$prelude_eq_g1int_int$2$1(ATSSELfltrec(ATSSELfltrec(tmpref11, postiats_tyrec_1, atslab$1), postiats_tyrec_0, atslab$0), ATSPMVi0nt(3))) ;
