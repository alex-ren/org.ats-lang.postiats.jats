...
ATSINSmove(tmp3, PMVtmpltcst(g1int2int<S2Eextkind(atstype_int), S2Evar(tk(3159))>)(arg1)) ;
ATSINSmove(tmpret2, PMVtmpltcst(g1int_gt<S2Evar(tk(3159))>)(arg0, tmp3)) ;
/* funbodyinstrlst(end) */
ATSreturn(tmpret2) ;
...
imparg = tk(3159)
tmparg = S2Evar(tk(3159))
tmpsub = Some(tk(3159) -> S2Eextkind(atstype_int))
*/
atstkind_t0ype(atstype_bool)
...
ATSINSmove(tmp20, PMVtmpltcst(g1int2int<S2Eextkind(atstype_int), S2Evar(tk(3165))>)(arg1)) ;
ATSINSmove(tmpret19, PMVtmpltcst(g1int_eq<S2Evar(tk(3165))>)(arg0, tmp20)) ;
/* funbodyinstrlst(end) */
ATSreturn(tmpret19) ;
