...
ATSglobaldec()
atstkind_t0ype(atstype_int)
ATSLIB_056$prelude_gnumber_int$3(atstkind_t0ype(atstype_int)) ;
#endif // end of [QUALIFIED]
#endif // end of [TEMPLATE]

ATSstaticdec()
atstkind_t0ype(atstype_int)
ATSLIB_056$prelude_gnumber_int$3$1(atstkind_t0ype(atstype_int)) ;
...
ATSstaticdec()
atstkind_t0ype(atstype_int)
ATSLIB_056$prelude_gnumber_int$3$2(atstkind_t0ype(atstype_int)) ;
...
ATSstaticdec()
atstkind_t0ype(atstype_int)
ATSLIB_056$prelude_gnumber_int$3$3(atstkind_t0ype(atstype_int)) ;
...
ATSglobaldec()
atstkind_t0ype(atstype_double)
ATSLIB_056$prelude_gnumber_int$22(atstkind_t0ype(atstype_int)) ;
#endif // end of [QUALIFIED]
#endif // end of [TEMPLATE]

ATSstaticdec()
atstkind_t0ype(atstype_double)
ATSLIB_056$prelude_gnumber_int$22$1(atstkind_t0ype(atstype_int)) ;
...
ATSstaticdec()
atstkind_t0ype(atstype_double)
ATSLIB_056$prelude_gnumber_int$22$2(atstkind_t0ype(atstype_int)) ;
...
ATSstaticdec()
atstkind_t0ype(atstype_double)
ATSLIB_056$prelude_gnumber_int$22$3(atstkind_t0ype(atstype_int)) ;
...
#if(0)
/*
/home/grad2/aren/workspace/Postiats/projects/org.ats-lang.postiats.jats/test/gfib.dats: 447(line=29, offs=6) -- 751(line=45, offs=4)
*/
/*
local: 
...
ATSINSmove(tmp2, PMVtmpltcst(gnumber_int<S2Evar(a(3287))>)(ATSPMVi0nt(2))) ;
ATSINSmove(tmp1, PMVtmpltcst(ggte_val<S2Evar(a(3287))>)(arg0, tmp2)) ;
ATSif(
tmp1
) ATSthen() {
ATSINSmove(tmp5, PMVtmpltcst(gnumber_int<S2Evar(a(3287))>)(ATSPMVi0nt(1))) ;
ATSINSmove(tmp4, PMVtmpltcst(gsub_val<S2Evar(a(3287))>)(arg0, tmp5)) ;
ATSINSmove(tmp3, PMVtmpltcst(gfib<S2Evar(a(3287))>)(tmp4)) ;
ATSINSmove(tmp8, PMVtmpltcst(gnumber_int<S2Evar(a(3287))>)(ATSPMVi0nt(2))) ;
ATSINSmove(tmp7, PMVtmpltcst(gsub_val<S2Evar(a(3287))>)(arg0, tmp8)) ;
ATSINSmove(tmp6, PMVtmpltcst(gfib<S2Evar(a(3287))>)(tmp7)) ;
ATSINSmove(tmpret0, PMVtmpltcst(gadd_val<S2Evar(a(3287))>)(tmp3, tmp6)) ;
} ATSelse() {
...
imparg = a(3287)
tmparg = S2Evar(a(3287))
tmpsub = Some(a(3287) -> S2Eapp(S2Ecst(g0int_t0ype); S2Ecst(int_kind)))
*/
atstkind_t0ype(atstype_int)
...
ATSINSmove(tmp2$1, ATSLIB_056$prelude_gnumber_int$3$1(ATSPMVi0nt(2))) ;
ATSINSmove(tmp1$1, ATSLIB_056$prelude_ggte_val$5$1(arg0, tmp2$1)) ;
ATSif(
tmp1$1
) ATSthen() {
ATSINSmove(tmp5$1, ATSLIB_056$prelude_gnumber_int$3$2(ATSPMVi0nt(1))) ;
...
ATSINSmove(tmp8$1, ATSLIB_056$prelude_gnumber_int$3$3(ATSPMVi0nt(2))) ;
...
#if(0)
/*
/home/grad2/aren/workspace/Postiats/ATS-Postiats/prelude/DATS/gnumber_int.dats: 1564(line=45, offs=18) -- 1590(line=45, offs=44)
*/
/*
local: 
global: gnumber_int$3$0(level=0)
local: 
global: 
*/
ATSglobaldec()
...
*/
atstkind_t0ype(atstype_int)
ATSLIB_056$prelude_gnumber_int$3(atstkind_t0ype(atstype_int) arg0)
{
/* tmpvardeclst(beg) */
ATStmpdec(tmpret22, atstkind_t0ype(atstype_int)) ;
/* tmpvardeclst(end) */
/* funbodyinstrlst(beg) */
__patsflab_gnumber_int:
ATSINSmove(tmpret22, atspre_g0int2int_int_int(arg0)) ;
/* funbodyinstrlst(end) */
ATSreturn(tmpret22) ;
} /* end of [ATSLIB_056$prelude_gnumber_int$3] */
#endif // end of [TEMPLATE]
...
/*
local: 
global: gnumber_int$3$1(level=2)
local: 
global: 
*/
ATSstaticdec()
...
*/
atstkind_t0ype(atstype_int)
ATSLIB_056$prelude_gnumber_int$3$1(atstkind_t0ype(atstype_int) arg0)
{
/* tmpvardeclst(beg) */
...
/* funbodyinstrlst(end) */
ATSreturn(tmp22$1) ;
} /* end of [ATSLIB_056$prelude_gnumber_int$3$1] */
...
/* funbodyinstrlst(beg) */
__patsflab_ggte_val:
ATSINSmove(tmp25, PMVtmpltcst(gcompare_val<S2Evar(a(3267))>)(arg0, arg1)) ;
...
imparg = a(3267)
tmparg = S2Evar(a(3267))
tmpsub = Some(a(3267) -> S2Eapp(S2Ecst(g0int_t0ype); S2Ecst(int_kind)))
*/
atstkind_t0ype(atstype_bool)
...
ATSINSmove(tmp29, PMVtmpltcst(g0int2int<S2Eextkind(atstype_int), S2Evar(tk(3215))>)(arg1)) ;
ATSINSmove(tmpret28, PMVtmpltcst(g0int_gte<S2Evar(tk(3215))>)(arg0, tmp29)) ;
/* funbodyinstrlst(end) */
ATSreturn(tmpret28) ;
...
/*
local: 
global: gnumber_int$3$2(level=2)
local: 
global: 
*/
ATSstaticdec()
...
*/
atstkind_t0ype(atstype_int)
ATSLIB_056$prelude_gnumber_int$3$2(atstkind_t0ype(atstype_int) arg0)
{
/* tmpvardeclst(beg) */
...
/* funbodyinstrlst(end) */
ATSreturn(tmp22$2) ;
} /* end of [ATSLIB_056$prelude_gnumber_int$3$2] */

#if(0)
/*
/home/grad2/aren/workspace/Postiats/ATS-Postiats/prelude/DATS/gnumber_int.dats: 2458(line=96, offs=15) -- 2472(line=96, offs=29)
*/
/*
local: 
...
/*
local: 
global: gnumber_int$3$3(level=2)
local: 
global: 
*/
ATSstaticdec()
...
*/
atstkind_t0ype(atstype_int)
ATSLIB_056$prelude_gnumber_int$3$3(atstkind_t0ype(atstype_int) arg0)
{
/* tmpvardeclst(beg) */
...
/* funbodyinstrlst(end) */
ATSreturn(tmp22$3) ;
} /* end of [ATSLIB_056$prelude_gnumber_int$3$3] */
...
#if(0)
/*
/home/grad2/aren/workspace/Postiats/ATS-Postiats/prelude/DATS/gnumber_int.dats: 2273(line=85, offs=15) -- 2287(line=85, offs=29)
*/
/*
local: 
...
imparg = a(3287)
tmparg = S2Evar(a(3287))
tmpsub = Some(a(3287) -> S2Eapp(S2Ecst(g0float_t0ype); S2Ecst(double_kind)))
*/
atstkind_t0ype(atstype_double)
...
ATSINSmove(tmp2$2, ATSLIB_056$prelude_gnumber_int$22$1(ATSPMVi0nt(2))) ;
ATSINSmove(tmp1$2, ATSLIB_056$prelude_ggte_val$5$2(arg0, tmp2$2)) ;
ATSif(
tmp1$2
) ATSthen() {
ATSINSmove(tmp5$2, ATSLIB_056$prelude_gnumber_int$22$2(ATSPMVi0nt(1))) ;
...
ATSINSmove(tmp8$2, ATSLIB_056$prelude_gnumber_int$22$3(ATSPMVi0nt(2))) ;
...
#if(0)
/*
/home/grad2/aren/workspace/Postiats/ATS-Postiats/prelude/DATS/gnumber_float.dats: 1624(line=47, offs=21) -- 1655(line=47, offs=52)
*/
/*
local: 
global: gnumber_int$22$0(level=0)
local: 
global: 
*/
ATSglobaldec()
...
*/
atstkind_t0ype(atstype_double)
ATSLIB_056$prelude_gnumber_int$22(atstkind_t0ype(atstype_int) arg0)
{
/* tmpvardeclst(beg) */
...
/* funbodyinstrlst(end) */
ATSreturn(tmpret52) ;
} /* end of [ATSLIB_056$prelude_gnumber_int$22] */
#endif // end of [TEMPLATE]
...
/*
local: 
global: gnumber_int$22$1(level=2)
local: 
global: 
*/
ATSstaticdec()
...
*/
atstkind_t0ype(atstype_double)
ATSLIB_056$prelude_gnumber_int$22$1(atstkind_t0ype(atstype_int) arg0)
{
/* tmpvardeclst(beg) */
...
/* funbodyinstrlst(end) */
ATSreturn(tmp52$1) ;
} /* end of [ATSLIB_056$prelude_gnumber_int$22$1] */
...
imparg = a(3267)
tmparg = S2Evar(a(3267))
tmpsub = Some(a(3267) -> S2Eapp(S2Ecst(g0float_t0ype); S2Ecst(double_kind)))
*/
atstkind_t0ype(atstype_bool)
...
/*
local: 
global: gnumber_int$22$2(level=2)
local: 
global: 
*/
ATSstaticdec()
...
*/
atstkind_t0ype(atstype_double)
ATSLIB_056$prelude_gnumber_int$22$2(atstkind_t0ype(atstype_int) arg0)
{
/* tmpvardeclst(beg) */
...
/* funbodyinstrlst(end) */
ATSreturn(tmp52$2) ;
} /* end of [ATSLIB_056$prelude_gnumber_int$22$2] */

#if(0)
/*
/home/grad2/aren/workspace/Postiats/ATS-Postiats/prelude/DATS/gnumber_float.dats: 2791(line=113, offs=18) -- 2805(line=113, offs=32)
*/
/*
local: 
...
/*
local: 
global: gnumber_int$22$3(level=2)
local: 
global: 
*/
ATSstaticdec()
...
*/
atstkind_t0ype(atstype_double)
ATSLIB_056$prelude_gnumber_int$22$3(atstkind_t0ype(atstype_int) arg0)
{
/* tmpvardeclst(beg) */
...
/* funbodyinstrlst(end) */
ATSreturn(tmp52$3) ;
} /* end of [ATSLIB_056$prelude_gnumber_int$22$3] */
...
#if(0)
/*
/home/grad2/aren/workspace/Postiats/ATS-Postiats/prelude/DATS/gnumber_float.dats: 2643(line=104, offs=18) -- 2657(line=104, offs=32)
*/
/*
local: 
...
/*
/home/grad2/aren/workspace/Postiats/projects/org.ats-lang.postiats.jats/test/gfib.dats: 807(line=50, offs=7) -- 924(line=56, offs=2)
*/
/*
local: 
