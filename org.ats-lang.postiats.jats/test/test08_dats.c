...
/*
/home/grad2/aren/workspace/Postiats/projects/org.ats-lang.postiats.jats/test/test08.dats: 44(line=5, offs=5) -- 75(line=5, offs=36)
*/
/*
local: 
...
ATSINSmove(tmp7, PMVtmpltcst(g0int2int<S2Eextkind(atstype_int), S2Evar(tk(3150))>)(arg1)) ;
ATSINSmove(tmpret6, PMVtmpltcst(g0int_eq<S2Evar(tk(3150))>)(arg0, tmp7)) ;
/* funbodyinstrlst(end) */
ATSreturn(tmpret6) ;
...
/*
/home/grad2/aren/workspace/Postiats/projects/org.ats-lang.postiats.jats/test/test08.dats: 93(line=7, offs=17) -- 172(line=12, offs=7)
*/
/*
...
ATStmpdec(tmpref2, postiats_tyrec_0) ;
...
*/
ATSINSstore_fltrec_ofs (tmpref2, postiats_tyrec_0, atslab$0, ATSPMVi0nt(1)) ;
ATSINSstore_fltrec_ofs (tmpref2, postiats_tyrec_0, atslab$1, ATSPMVi0nt(2)) ;
ATSINSmove(tmp3, foo_0(tmpref2)) ;
ATSINSmove(tmp5, ATSLIB_056$prelude_eq_g0int_int$2$1(tmp3, ATSPMVi0nt(1))) ;
ATSINSmove_void(tmp4, atspre_assert_errmsg_bool0(tmp5, ATSCSTSPmyloc("/home/grad2/aren/workspace/Postiats/projects/org.ats-lang.postiats.jats/test/test08.dats: 147(line=10, offs=12) -- 163(line=10, offs=28)"))) ;
/*
letpush(end)
*/
...
*/
atsvoid_t0ype
_057$home_057$grad2_057$aren_057$workspace_057$Postiats_057$projects_057$org_056$ats_055$lang_056$postiats_056$jats_057$test_057$test08_056$dats__dynload()
{
ATSdynload0(
_057$home_057$grad2_057$aren_057$workspace_057$Postiats_057$projects_057$org_056$ats_055$lang_056$postiats_056$jats_057$test_057$test08_056$dats__dynloadflag
) ;
ATSif(
ATSCKiseqz(
_057$home_057$grad2_057$aren_057$workspace_057$Postiats_057$projects_057$org_056$ats_055$lang_056$postiats_056$jats_057$test_057$test08_056$dats__dynloadflag
...
ATSdynloadset(_057$home_057$grad2_057$aren_057$workspace_057$Postiats_057$projects_057$org_056$ats_055$lang_056$postiats_056$jats_057$test_057$test08_056$dats__dynloadflag) ;
/*
