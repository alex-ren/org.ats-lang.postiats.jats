...
** The compilation time is: 2013-6-25: 12h:45m
**
*/
...
ATSINSmove(tmp7, PMVtmpltcst(g0int2int<S2EVar(373->S2Eextkind(atstype_int)), S2EVar(374->S2Evar(tk(2907)))>)(arg1)) ;
ATSINSmove(tmpret6, PMVtmpltcst(g0int_eq<S2Evar(tk(2907))>)(arg0, tmp7)) ;
/* funbodyinstrlst(end) */
ATSreturn(tmpret6) ;
...
ATSINSmove(tmp5, _057$home_057$grad2_057$aren_057$workspace_057$Postiats_057$ATS_055$Postiats_057$prelude_057$SATS_057$integer_056$sats_eq_g0int_int$2$1(tmp3, ATSPMVi0nt(1))) ;
