...
** The compilation time is: 2013-6-25: 11h:30m
**
*/
...
ATSINSmove(tmp10, PMVtmpltcst(g1int2int<S2EVar(399->S2Eextkind(atstype_int)), S2EVar(400->S2Evar(tk(2922)))>)(arg1)) ;
ATSINSmove(tmpret9, PMVtmpltcst(g1int_eq<S2Evar(tk(2922))>)(arg0, tmp10)) ;
/* funbodyinstrlst(end) */
ATSreturn(tmpret9) ;
...
{
/* tmpvardeclst(beg) */
ATStmpdec(tmp9$1, atstkind_t0ype(atstype_bool)) ;
ATStmpdec(tmp10$1, atstkind_t0ype(atstype_int)) ;
/* tmpvardeclst(end) */
/* funbodyinstrlst(beg) */
__patsflab_eq_g1int_int:
ATSINSmove(tmp10$1, atspre_g1int2int_int_int(arg1)) ;
ATSINSmove(tmp9$1, atspre_g1int_eq_int(arg0, tmp10$1)) ;
/* funbodyinstrlst(end) */
ATSreturn(tmp9$1) ;
...
/*
/home/grad2/aren/workspace/Postiats/projects/org.ats-lang.postiats.jats/test/test02.dats: 90(line=6, offs=17) -- 278(line=15, offs=7)
*/
/*
local: 
...
ATStmpdec(tmpref5, postiats_tyrec_0) ;
...
*/
ATSINSmove_boxrec(tmpref1, postiats_tyrec_1) ;
ATSINSstore_boxrec_ofs (tmpref1, postiats_tyrec_1, atslab$0, ATSPMVi0nt(1)) ;
ATSINSstore_boxrec_ofs (tmpref1, postiats_tyrec_1, atslab$1, ATSPMVi0nt(2)) ;
...
ATSINSstore_boxrec_ofs (tmp4, postiats_tyrec_1, atslab$0, ATSPMVi0nt(2)) ;
ATSINSstore_boxrec_ofs (tmp4, postiats_tyrec_1, atslab$1, ATSPMVi0nt(3)) ;
ATSINSstore_fltrec_ofs (tmpref3, postiats_tyrec_2, atslab$0, ATSPMVi0nt(1)) ;
ATSINSstore_fltrec_ofs (tmpref3, postiats_tyrec_2, atslab$1, tmp4) ;
/*
ATSINStmpdec(tmpref5)) ;
*/
ATSINSmove_boxrec(tmp6, postiats_tyrec_1) ;
ATSINSstore_boxrec_ofs (tmp6, postiats_tyrec_1, atslab$0, ATSPMVi0nt(21)) ;
ATSINSstore_boxrec_ofs (tmp6, postiats_tyrec_1, atslab$1, ATSPMVi0nt(31)) ;
ATSINSstore_fltrec_ofs (tmpref5, postiats_tyrec_2, atslab$0, ATSPMVi0nt(11)) ;
ATSINSstore_fltrec_ofs (tmpref5, postiats_tyrec_2, atslab$1, tmp6) ;
ATSINSstore(tmpref3, tmpref5) ;
ATSINSmove(tmp8, _057$home_057$grad2_057$aren_057$workspace_057$Postiats_057$ATS_055$Postiats_057$prelude_057$SATS_057$integer_056$sats_eq_g1int_int$1$1(ATSselboxrec(ATSselfltrec(tmpref5, postiats_tyrec_2, atslab$1), postiats_tyrec_1, atslab$0), ATSPMVi0nt(21))) ;
ATSINSmove_void(tmp7, atspre_assert_errmsg_bool1(tmp8, ATSCSTSPmyloc("/home/grad2/aren/workspace/Postiats/projects/org.ats-lang.postiats.jats/test/test02.dats: 247(line=13, offs=12) -- 269(line=13, offs=34)"))) ;
/*
letpush(end)
*/
