...
ATSINSmove(tmp10, PMVtmpltcst(g1int2int<S2Eextkind(atstype_int), S2Evar(tk(3231))>)(arg1)) ;
ATSINSmove(tmpret9, PMVtmpltcst(g1int_eq<S2Evar(tk(3231))>)(arg0, tmp10)) ;
/* funbodyinstrlst(end) */
ATSreturn(tmpret9) ;
...
ATSINSmove(tmp8, ATSLIB_056$prelude_eq_g1int_int$1$1(ATSSELboxrec(ATSSELfltrec(tmpref5, postiats_tyrec_2, atslab$1), postiats_tyrec_1, atslab$0), ATSPMVi0nt(21))) ;
