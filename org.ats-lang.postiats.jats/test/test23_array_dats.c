...
ATSINSmove(tmp6, PMVtmpltcst(ptr1_add_gint<S2Evar(a(5169))><S2Evar(tk(5170))>)(ATSPMVcastfn(arrayptr2ptr, atstkind_type(atstype_ptrk), ATSPMVrefarg0(arg0)), arg1)) ;
ATSINSmove(tmpret5, PMVtmpltcst(ptr0_get<S2Evar(a(5169))>)(tmp6)) ;
/*
INSletpop()
*/
/* funbodyinstrlst(end) */
...
ATSINSmove(tmp10, PMVtmpltcst(ptr0_add_gint<S2Evar(a(3476))><S2Evar(tk(3477))>)(arg0, arg1)) ;
...
ATSINSmove(tmp15, PMVtmpltcst(g0int2uint<S2Evar(tk(3463)), S2Eextkind(atstype_size)>)(arg1)) ;
...
ATSINSmove(tmp26, PMVtmpltcst(g0int2int<S2Eextkind(atstype_int), S2Evar(tk(3194))>)(arg1)) ;
ATSINSmove(tmpret25, PMVtmpltcst(g0int_eq<S2Evar(tk(3194))>)(arg0, tmp26)) ;
/* funbodyinstrlst(end) */
ATSreturn(tmpret25) ;
