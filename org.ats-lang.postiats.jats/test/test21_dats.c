...
ATSINSmove(tmp8, PMVtmpltcst(g1int2int<S2Eextkind(atstype_int), S2Evar(tk(3165))>)(arg1)) ;
ATSINSmove(tmpret7, PMVtmpltcst(g1int_eq<S2Evar(tk(3165))>)(arg0, tmp8)) ;
/* funbodyinstrlst(end) */
ATSreturn(tmpret7) ;
...
ATSINSmove(tmp6, ATSLIB_056$prelude_eq_g1int_int$1$1(ATSSELfltrec(tmp1, postiats_tyrec_0, atslab$0), ATSPMVi0nt(5))) ;
