...
ATSINSmove(tmp11, PMVtmpltcst(g0int2int<S2Eextkind(atstype_int), S2Evar(tk(3150))>)(arg1)) ;
ATSINSmove(tmpret10, PMVtmpltcst(g0int_eq<S2Evar(tk(3150))>)(arg0, tmp11)) ;
/* funbodyinstrlst(end) */
ATSreturn(tmpret10) ;
...
/*
/home/grad2/aren/workspace/Postiats/projects/org.ats-lang.postiats.jats/test/test11.dats: 116(line=9, offs=17) -- 279(line=20, offs=7)
*/
/*
...
ATSINSmove_void(tmp8, atspre_assert_errmsg_bool0(tmp9, ATSCSTSPmyloc("/home/grad2/aren/workspace/Postiats/projects/org.ats-lang.postiats.jats/test/test11.dats: 252(line=17, offs=12) -- 269(line=17, offs=29)"))) ;
/*
letpush(end)
*/
